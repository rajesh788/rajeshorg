...
export default class fieldExportCustomLookup extends LightningElement {
    ...
    exportDataMtd (){
            this.subscription5 = subscribe(this.messageContext,ExportRsltLMS, (message) => {
                ...
                console.log('message .objectFields ==> ',this.objectFields);

    });
        } 
        handleFilterIcon() {
            this.isOpenFilterBox = true;
            publish(this.messageContext,OpenRangeSectionLMS,{OpenSection:this.isOpenFilterBox,closeFilterSection:this.iscloseFilterBox});
        }
        exportData() {
